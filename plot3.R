# Plot a graph with 3 lines for submetering data and output the results
...
submeter_line1 <- as.numeric(sub_data$Sub_metering_1)
...
plot(date_time, submeter_line1, type="l", xlab="", ylab="Energy sub metering")
